...
class MesageWidget extends StatefulWidget {
  const MesageWidget({Key? key}) : super(key: key);

  @override
  _MesageWidgetState createState() => _MesageWidgetState();
}

class _MesageWidgetState extends State<MesageWidget>
  ...
  void initState() {
    ...
    cityController3 = TextEditingController();
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20, 15, 20, 16),
              child: TextFormField(
